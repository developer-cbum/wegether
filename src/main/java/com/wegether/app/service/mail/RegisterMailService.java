package com.wegether.app.service.mail;
...
//		System.out.println("인증 번호 : " + ePw);
        ...
        message.setSubject("Wegether 회원가입 이메일 인증");// 제목

        String msgg = "";
        msgg += "<div style='margin:100px;'>";
        msgg += "<h1> 안녕하세요</h1>";
        msgg += "<h1> Wegether 입니다</h1>";
        msgg += "<br>";
        ...
        message.setFrom(new InternetAddress("boy9801@naver.com", "Wegether_Admin"));// 보내는 사람
