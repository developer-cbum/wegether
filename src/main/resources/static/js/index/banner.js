...
$image_divs.each((i, image_div) => {$(image_div).css("background-image", `url(/static/img/00${i + 1}.jpeg)`)});
$first_div.css("background-image", `url(/static/img/00${$image_divs.length}.jpeg)`);
$last_div.css("background-image", `url(/static/img/001.jpeg)`);
